...
def read_edf(filename, start, stop=None, missing=0.0, debug=False, eye='L'):
	...
	for line in raw:
		...
		if started:
			...
			# fixation start
				...
				if (line[5]=='L' and eye=='L') or (line[5]=='R' and eye=='R'):
			...
			# saccade start
				...
				if (line[6]=='L' and eye=='L') or (line[6]=='R' and eye=='R'):
			...
			# blink start
				...
				if (line[7]=='L' and eye=='L') or (line[7]=='R' and eye=='R'):
					message("blink start")
					l = line[9:]
